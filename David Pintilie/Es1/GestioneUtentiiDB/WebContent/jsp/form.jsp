<div class="container">
    	...
    	<form action="http://localhost:8080/GestioneUtentiiDB/gestione"id="method">
		  ...
		  <button type="button" class="btn btn-primary"value="lista"onclick="location.href='http://localhost:8080/GestioneUtentiiDB/display'">Clicca qui per accedere</button>
		</form>
    </div>